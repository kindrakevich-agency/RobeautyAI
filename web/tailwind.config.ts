...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Тло світлої теми майже нейтральне (хрома 2). Попереднє #E5DED3
        // мало хрому 18 — саме через неї воно читалося брудно-бежевим.
        // Заразом картка на ньому відділяється краще: 1.12 проти 1.07
        // у чистого #F7F7F7 бренду.
        cream: { 50: '#FFFFFF', 100: '#F8F8F7', 200: '#F2F2F0', 300: '#E8E8E5' },
        ink: {
          950: '#191A1B', 900: '#2E2E2E', 800: '#3D3D3D', 700: '#545454',
          600: '#606060', 500: '#8A8A8A', 400: '#A6A6A6', 300: '#C7C7C7',
          200: '#DDDDDA', 100: '#EFEFED',
        },
